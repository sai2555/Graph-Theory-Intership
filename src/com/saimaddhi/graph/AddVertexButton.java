...
/**
 * Represents the Add Vertex button on the UI
 * @author saimaddhi
 *
 */
public class AddVertexButton {
	/**
	 ...
	 */
	public AddVertexButton(double xCoor, double yCoor, double radius) {
		this.xCoor = xCoor;
		this.yCoor = yCoor;
		this.radius = radius;
		this.lightGray = true;
